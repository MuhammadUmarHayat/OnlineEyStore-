<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CategoryManagement.aspx.cs" Inherits="OnlineEyeStore.CategoryManagement" %>
...
&nbsp;|<asp:HyperLink ID="HyperLink6" runat="server" NavigateUrl="~/OrderManagement.aspx">Place Order</asp:HyperLink>
                ...
                <tr>
                    <td>&nbsp;</td>
                    <td>
                        <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" BackColor="White" BorderColor="#3366CC" BorderStyle="None" BorderWidth="1px" CellPadding="4" DataSourceID="SqlDataSource1" DataKeyNames="Id">
                            <Columns>
                        ...
                        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:EyStoreFinalDBConnectionString %>" SelectCommand="SELECT DISTINCT * FROM [Category]" UpdateCommand="update [Category] set title=@title, discription=@discription where id=@id" DeleteCommand="delete from [Category] where id=@id"></asp:SqlDataSource>
                    </td>
                    <td>&nbsp;</td>
                </tr>
                <tr>
