<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ItemManagement.aspx.cs" Inherits="OnlineEyeStore.ItemManagement" %>
...
&nbsp;|<asp:HyperLink ID="HyperLink6" runat="server" NavigateUrl="~/OrderManagement.aspx">Place Order</asp:HyperLink>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:EyStoreFinalDBConnectionString %>" SelectCommand="SELECT * FROM [Items]" UpdateCommand="update Items set [title]=@title, [category]=@category, [unitPrice]=@unitPrice, [quantity]=@quantity, [Remarks]=@Remarks where itemid=@itemid" DeleteCommand="delete from items where itemid=@itemid"></asp:SqlDataSource>
                    </td>
                    <td>&nbsp;</td>
                </tr>
                <tr>
